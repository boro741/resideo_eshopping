...
import 'package:resideo_eshopping/stores/product_list_page_store.dart';
...
class _ProductsListPageState extends State<ProductsListPage>
  ...
  final _store = ProductsListPageStore();
...
//  }
  ...
  Widget build(BuildContext context) {
    ...
    _store.setProfile();
      ...
      if(_isProgressBarShown){
       ...
       if(isProfile)
       {
         return SignUp(widget.user,_store.closeUserProfile(),userInfo);
       }else{
        return Scaffold(
          key: key,
          drawer: Drawer(
                        ...
                        ExpansionTile(
                          ...
                          children: <Widget>[
                                  _createDrawerItem(
                                    ...
                                    text: 'All',
                                    onTap: () => _store.getProduct('All')),

                                  _createDrawerItem(
                                    icon: FontAwesomeIcons.male,
                                    text: 'Men',
                                    onTap: () => _store.getProduct('Men')),

                                  _createDrawerItem(
                                    icon: FontAwesomeIcons.female,
                                    text: 'Women',
                                    onTap: () => _store.getProduct('Women')),

                                _createDrawerItem(
                                    icon: FontAwesomeIcons.child,
                                    text: 'Kids',
                                    onTap: () => _store.getProduct('Kid')),
  ...
  void initState() {
   ...
   _store.getUserDetail();
   _store.getProduct("All");
